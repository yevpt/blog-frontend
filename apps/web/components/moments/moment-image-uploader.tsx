...
export function MomentImageUploader({ items, onChange, disabled, readOnly = false }: Props) {
...
function StaticThumb({ item, onPreview }: { item: MomentImageItem; onPreview: () => void }) {
  return (
